    ...
    return (
        <>
             <div className="d-flex flex-row ">
                ...
                <div className=" text-center "  style={{width:'18rem', wordWrap:' break-word'}}><strong>{monitorlink.source_link}</strong></div>
                <div className=" text-center "  style={{width:'18rem', wordWrap:' break-word'}}><strong>{monitorlink.target_link}</strong></div>
