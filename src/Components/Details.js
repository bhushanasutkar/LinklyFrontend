...
const Details = (props) => {
  ...
  return (
    <>
      ...
      />
      <div>
        <div className=" py-1 container d-flex flex-row ">
          <div
          ...
          >
            <div className="container d-flex flex-column">
              ...
              <p>
                <strong>Categories :</strong> Category1, Category2, Category3,
                Category4
              </p>
            </div>
            <div
            ...
            >
              ...
              <p style={{ marginLeft: "20px" }}>
                Organic Keywords :<strong>1900</strong>
              </p>
              <p style={{ marginLeft: "20px" }}>
                No of backlins :<strong>1900</strong>
              </p>
              <p style={{ marginLeft: "20px" }}>
                Linking Domain :<strong>1900</strong>
              </p>
              <p style={{ marginLeft: "20px" }}>
                Alexa Rank :<strong className="px-1">{link.Alexa_Rank}</strong>
              </p>
            </div>
            <div
              className="container mx-0 d-flex flex-column"
