  ...
  return (
    <>
      ...
      <div className="text-light text-start container class1">
        ...
        <div>
            <div className="container  Navhover ml-2  d-flex flex-row justify-content-start align-items-center"  style={{backgroundColor:`${location.pathname==='/backlinkvault'?'rgb(215, 240, 240)':"rgb(45, 45, 45)"}`}}>
                <AddCircleIcon className="Icon"></AddCircleIcon>
        ...
        <div>
            <div className="container  Navhover ml-2  d-flex flex-row justify-content-start align-items-center"  style={{backgroundColor:`${location.pathname==='/backlinkmanager'?'rgb(215, 240, 240)':"rgb(45, 45, 45)"}`}}>
        ...
        <div>
            <div className="container  Navhover ml-2  d-flex flex-row justify-content-start align-items-center"  style={{backgroundColor:`${location.pathname==='/backlinkmonitor'?'rgb(215, 240, 240)':"rgb(45, 45, 45)"}`}}>
        ...
        <div>
            <div className="container  Navhover ml-2  d-flex flex-row justify-content-start align-items-center"  style={{backgroundColor:`${location.pathname==='/linkgiver'?'rgb(215, 240, 240)':"rgb(45, 45, 45)"}`}}>
        ...
        <div>
            <div className="container mb-4 Navhover ml-2  d-flex flex-row justify-content-start align-items-center"  style={{backgroundColor:`${location.pathname==='/orderdashboard'?'rgb(215, 240, 240)':"rgb(45, 45, 45)"}`}}>
        ...
        <hr  />
        <div>
            <div className="container  Navhover ml-2 mt-4  d-flex flex-row justify-content-start align-items-center"  style={{backgroundColor:`${location.pathname==='/s'?'rgb(215, 240, 240)':"rgb(45, 45, 45)"}`}}>
                <SettingsIcon className="Icon"></SettingsIcon>
                <Link className="  px-3  Navtext" to="/backlinkvault">Settings</Link>
            </div>
            <div className="container  Navhover ml-2   d-flex flex-row justify-content-start align-items-center" style={{backgroundColor:`${location.pathname==='/s'?'rgb(215, 240, 240)':"rgb(45, 45, 45)"}`}}>
                <SubscriptionsIcon className="Icon"></SubscriptionsIcon>
                <Link className="  px-3  Navtext" to="/backlinkvault">Subscription</Link>
            </div>
        </div>
